        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            <li class="menu active">
                <a href="#dashboard" data-bs-toggle="collapse" aria-expanded="true" class="dropdown-toggle">
                    <div class="">
                        ...
                        <span>{{ trans('dashboard_tr\Layout_tr\aside_tr.Admin') }}</span>
                    </div>
                    <div>
                ...
                <ul class="collapse submenu list-unstyled show" id="dashboard" data-bs-parent="#accordionExample">
                    <li class="active">
                        <a href={{route('admin.index')}}> {{ trans('dashboard_tr\Layout_tr\aside_tr.Admins_Table') }} </a>
                    </li>
                    <li>
                        <a href={{route('admin.create')}}> {{ trans('dashboard_tr\Layout_tr\aside_tr.Add_Admin') }} </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="menu">
                <a href="#apps" data-bs-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        ...
                        <span>{{ trans('dashboard_tr\Layout_tr\aside_tr.Blogs') }}</span>
                    </div>
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right"><polyline points="9 18 15 12 9 6"></polyline></svg>
                    </div>
                ...
                <ul class="collapse submenu list-unstyled" id="apps" data-bs-parent="#accordionExample">
                    ...
                    <li>
                        <a href={{route('admin.blogsCategory.index')}}> {{ trans('dashboard_tr\Layout_tr\aside_tr.BlogCategory') }} </a>
                    </li>
                    <li>
                        <a href={{route('admin.blogsCategory.create')}}> {{ trans('dashboard_tr\Layout_tr\aside_tr.Add_blogs_Category') }} </a>
                    </li>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="components" data-bs-parent="#accordionExample">
                    <li>
                        <a href={{route('admin.role.index')}}>  Roles Table </a>
                    </li>
                    <li>
                        <a href={{route('admin.role.create')}}> Add Role  </a>
                    </li>
                    <li>
                        <a href={{route('admin.permission.index')}}>  Permission Table </a>
                    </li>
                    <li>
